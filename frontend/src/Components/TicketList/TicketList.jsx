...
import {
  ...
  FiClock, FiLoader, FiMonitor, FiArchive, FiBox, FiHome,
} from "react-icons/fi";
...
const STATUS_META = {
  ...
  IN_PROGRESS: { cls: "status-in-progress", dot: "#f59e0b", Icon: FiLoader        },
      ...
      <div className="tl-content">
        {filtered.length === 0 ? (
          <div className="tl-empty">
            ...
            {hasFilters && <button className="tl-reset-btn" onClick={clearFilters}>Clear all filters</button>}
          </div>
        ) : view === "grid" ? (
